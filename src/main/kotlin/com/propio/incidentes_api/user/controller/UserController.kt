...
class UserController(val userService : UserService) {
    ...
    @PutMapping("/me")
    fun updateMe(@RequestHeader("Authorization") token: String, @RequestBody updateUserBody: UpdateUserBody): ResponseEntity<UserD> {
        val updatedUser = userService.updateUser(token, updateUserBody)
